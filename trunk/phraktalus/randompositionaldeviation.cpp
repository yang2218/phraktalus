...
RandomPositionalDeviation::RandomPositionalDeviation():PositionalDeviation()
{
    srand(time(0));
}

double RandomPositionalDeviation::getDeviation(unsigned x,unsigned y){
    return ((rand()%200)-100.0)/100.0;
}
